...
You need to start a second web server (by default listening on 3001)
...
8081 and sockjs-client on 3001. When you open the browser on
[http://localhost:3001/](http://localhost:3001/) you should be able
